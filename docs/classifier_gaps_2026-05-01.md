...
- [x] **G01 — `1099` numeric+letter suffix** (4 errors)
...
- [x] **G02 — Schwab CSV filename pattern** (6 errors)
...
- [x] **G03 — Schwab brokerage statement PDF** (2 errors)
...
- [x] **G06 — "Engagement letter" → legal_services_agreement** (3 errors)
...
- [x] **G07 — California "Certificate of Status"** (1 error)
...
- [x] **G08 — `i20` vs `transfer_pending_letter`** (12 errors)
...
- [x] **G09 — `cpt_application` vs `i983`** (1 error)
...
- [x] **G10 — `articles_of_organization` vs `ein_application`** (12 errors)
...
- [x] **G11 — `corporate_resolution` / `board_resolution`** (12 errors)
...
- [x] **G13 — `ein_fax_notification`** (7 errors)
...
- [x] **G14 — `governance_doc` / `eminutes_packet`** (7 errors)
...
- [x] **G15 — `statement_of_information` / `state_filing`** (6 errors)
...
- [x] **G16 — `payroll_summary`** (5 errors)
...
- [x] **G17 — `termination_letter` / `employment_termination`** (4 errors)
...
- [x] **G18 — `employer_questionnaire`** (4 errors)
...
- [x] **G20 — Litigation correspondence cluster** (3 errors)
...
- [x] **G21 — Litigation chain correspondence (lettered exhibits)** (3 errors)
...
- [x] **G23 — `attorney_intake_doc`** (2 errors)
...
- [x] **G24 — `materiality_difference_memo`** (2 errors)
...
- [x] **G27 — `i129_support_letter`** (1 error)
...
- [x] **G28 — `transaction_ledger`** (1 error)
...
- [x] **G29 — Numbered-prefix filename + dir context** (14 errors)
...
- [x] **G30 — Multi-doc compilation filename** (7 errors)
...
- [x] **G31 — `articles_and_ss4` combined PDFs** (12 errors)
...
- [x] **G32 — `cpt_application + training_plan`** (1 error)
   - Same root as G31. Fix together.

- [x] **G33 — `articles + bylaws + corporate_resolution` triple** (counts within G14 governance_packet)
