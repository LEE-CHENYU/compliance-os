...
const TITLE = "Find a vetted professional — attorneys and CPAs";
const DESC =
  "Tell Guardian your case and get a curated shortlist of attorneys or CPAs with case-specific persona-fit reasoning. $15 per search; saved results tracked in your dashboard alongside your case documents and Gmail threads.";
